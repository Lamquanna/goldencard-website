...
function SignInContent() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-amber-50 via-yellow-50 to-orange-50">
      <div className="max-w-md w-full p-8 bg-[#0A0A0A] rounded-2xl shadow-xl">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-6 py-3 bg-[#0A0A0A] border-2 border-neutral-200 rounded-lg hover:bg-neutral-50 transition-colors"
        >
