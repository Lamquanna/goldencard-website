...
const navItems = [
  { name: "Tasks", href: "/crm/tasks", icon: Icons.tasks, badge: null },
  { name: "Leads", href: "/crm/leads", icon: Icons.leads, badge: null },
  { name: "Projects", href: "/crm/projects", icon: Icons.projects, badge: null },
  { name: "Inventory", href: "/crm/inventory", icon: Icons.inventory, badge: null },
  { name: "Analytics", href: "/crm/analytics", icon: Icons.analytics, badge: null },
  { name: "Attendance", href: "/crm/attendance", icon: Icons.attendance, badge: null },
  { name: "Maps", href: "/crm/maps", icon: Icons.maps, badge: null },
  { name: "Automations", href: "/crm/automations", icon: Icons.automations, badge: null },
];

const adminNavItems = [
  { name: "Users", href: "/crm/users", icon: Icons.users, badge: null },
];
...
export default function CRMLayout({ children }: { children: React.ReactNode }) {
  ...
  const isActive = (href: string) => {
    if (href === "/crm/tasks") {
      return pathname === "/crm" || pathname === "/crm/tasks";
    }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 h-16 bg-white border-b border-gray-200 z-50 flex items-center justify-between px-4">
        ...
        <Link href="/crm/tasks" className="flex items-center gap-2">
