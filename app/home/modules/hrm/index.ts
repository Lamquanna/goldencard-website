...
// HRM Routes
const hrmRoutes = [
  { path: '/home/hrm', name: 'Dashboard', nameVi: 'Tổng quan', icon: 'LayoutDashboard', showInSidebar: true },
  { path: '/home/hrm/employees', name: 'Employees', nameVi: 'Nhân viên', icon: 'Users', showInSidebar: true },
  { path: '/home/hrm/attendance', name: 'Attendance', nameVi: 'Chấm công', icon: 'Clock', showInSidebar: true },
  { path: '/home/hrm/leaves', name: 'Leave Management', nameVi: 'Nghỉ phép', icon: 'Calendar', showInSidebar: true },
  { path: '/home/hrm/payroll', name: 'Payroll', nameVi: 'Bảng lương', icon: 'Wallet', showInSidebar: true },
  { path: '/home/hrm/departments', name: 'Departments', nameVi: 'Phòng ban', icon: 'Building2', showInSidebar: true },
  { path: '/home/hrm/reports', name: 'HR Reports', nameVi: 'Báo cáo', icon: 'FileText', showInSidebar: true },
];
