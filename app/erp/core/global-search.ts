...
export const commandPaletteItems: CommandPaletteItem[] = [
  ...
  { id: 'nav-crm', type: 'navigation', title: 'Go to CRM', titleVi: 'Đi đến CRM', icon: '💼', url: '/erp/crm', shortcut: 'g c' },
  { id: 'nav-hrm', type: 'navigation', title: 'Go to HRM', titleVi: 'Đi đến HRM', icon: '👥', url: '/erp/hrm', shortcut: 'g h' },
  { id: 'nav-projects', type: 'navigation', title: 'Go to Projects', titleVi: 'Đi đến Dự án', icon: '📁', url: '/erp/projects', shortcut: 'g p' },
  { id: 'nav-inventory', type: 'navigation', title: 'Go to Inventory', titleVi: 'Đi đến Kho', icon: '📦', url: '/erp/inventory', shortcut: 'g i' },
  { id: 'nav-finance', type: 'navigation', title: 'Go to Finance', titleVi: 'Đi đến Tài chính', icon: '💰', url: '/erp/finance', shortcut: 'g f' },
