...
export const InventoryModuleManifest: ModuleManifest = {
  ...
  color: '#F59E0B', // Amber
  category: 'operations',
  basePath: '/erp/inventory',
  author: 'Golden Energy',
  routes: [
    { path: '/erp/inventory', name: 'Overview', nameVi: 'Tổng quan', icon: 'Package' },
    { path: '/erp/inventory/products', name: 'Products', nameVi: 'Sản phẩm', icon: 'Box' },
    { path: '/erp/inventory/warehouses', name: 'Warehouses', nameVi: 'Kho hàng', icon: 'Warehouse' },
    { path: '/erp/inventory/stock-in', name: 'Stock In', nameVi: 'Nhập kho', icon: 'ArrowDownToLine' },
    { path: '/erp/inventory/stock-out', name: 'Stock Out', nameVi: 'Xuất kho', icon: 'ArrowUpFromLine' },
    { path: '/erp/inventory/transfers', name: 'Transfers', nameVi: 'Chuyển kho', icon: 'ArrowLeftRight' },
    { path: '/erp/inventory/adjustments', name: 'Adjustments', nameVi: 'Điều chỉnh', icon: 'RefreshCw' },
    { path: '/erp/inventory/reports', name: 'Reports', nameVi: 'Báo cáo', icon: 'FileBarChart' },
  ],
  permissions: [
    { 
      id: 'inventory.view', 
