...
export const FinanceModuleManifest: ModuleManifest = {
  ...
  color: '#8B5CF6', // Violet
  category: 'finance',
  basePath: '/erp/finance',
  author: 'Golden Energy',
  routes: [
    { path: '/erp/finance', name: 'Overview', nameVi: 'Tổng quan', icon: 'Wallet' },
    { path: '/erp/finance/invoices', name: 'Invoices', nameVi: 'Hóa đơn', icon: 'FileText' },
    { path: '/erp/finance/payments', name: 'Payments', nameVi: 'Thanh toán', icon: 'CreditCard' },
    { path: '/erp/finance/expenses', name: 'Expenses', nameVi: 'Chi phí', icon: 'Receipt' },
    { path: '/erp/finance/budgets', name: 'Budgets', nameVi: 'Ngân sách', icon: 'PiggyBank' },
    { path: '/erp/finance/reports', name: 'Reports', nameVi: 'Báo cáo', icon: 'BarChart3' },
  ],
  permissions: [
    { 
      id: 'finance.view', 
