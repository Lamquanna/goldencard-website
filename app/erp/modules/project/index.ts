...
export const ProjectModuleManifest: ModuleManifest = {
  ...
  color: '#6366F1', // Indigo
  category: 'operations',
  basePath: '/erp/projects',
  author: 'Golden Energy',
  routes: [
    { path: '/erp/projects', name: 'Projects', nameVi: 'Dự án', icon: 'FolderKanban' },
    { path: '/erp/projects/board', name: 'Board View', nameVi: 'Kanban Board', icon: 'Columns' },
    { path: '/erp/projects/timeline', name: 'Timeline', nameVi: 'Timeline', icon: 'GitBranch' },
    { path: '/erp/projects/gantt', name: 'Gantt Chart', nameVi: 'Gantt Chart', icon: 'GanttChart' },
    { path: '/erp/projects/calendar', name: 'Calendar', nameVi: 'Lịch', icon: 'Calendar' },
  ],
  permissions: [
    { 
      id: 'project.view', 
