...
// Types & Config
import type { Lead, Deal, CRMActivity } from '@/app/erp/modules/crm';
import { LEAD_STATUS_CONFIG, DEAL_STAGE_CONFIG, getRatingColor } from '@/app/erp/modules/crm';
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              ...
              <Link href="/erp/crm/leads?rating=hot">
                <Button variant="outline" size="sm">
                  Xem
                </Button>
              </Link>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              ...
              <Link href="/erp/crm/leads?follow_up=overdue">
                <Button variant="outline" size="sm">
                  Xem
                </Button>
              </Link>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              ...
              <Link href="/erp/crm/deals?closing=7days">
                <Button variant="outline" size="sm">
                  Xem
                </Button>
              </Link>
