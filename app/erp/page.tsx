      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          >
            <div className="flex items-center justify-between mb-4">
              ...
              <Link href="/erp/dashboard" className="text-sm text-[#D4AF37] hover:underline flex items-center gap-1">
        ...
        >
          <div className="flex items-center justify-between mb-6">
            ...
            <Link href="/erp/projects" className="text-sm text-[#D4AF37] hover:underline flex items-center gap-1">
        ...
        >
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-8 gap-3">
            {[
              { name: 'Dashboard', icon: Icons.dashboard, href: '/erp/dashboard' },
              { name: 'Tasks', icon: Icons.tasks, href: '/erp/tasks' },
              { name: 'Leads', icon: Icons.leads, href: '/erp/leads' },
              { name: 'Projects', icon: Icons.projects, href: '/erp/projects' },
              { name: 'Inventory', icon: Icons.inventory, href: '/erp/inventory' },
              { name: 'Analytics', icon: Icons.analytics, href: '/erp/analytics' },
              { name: 'Maps', icon: Icons.maps, href: '/erp/maps' },
              { name: 'Automations', icon: Icons.automations, href: '/erp/automations' },
            ].map((item) => (
